...
abundance <- ggplot(data = abundance_by_site,
  ...
  geom_jitter(width = 0.15,
              height = 0,
              alpha = 0.7) +
  # add median point for each site within each taxon
  stat_summary(fun = median,
               geom = "point",
               shape = 18,
               size = 3,
...
```
The chi-square test suggests that taxon composition differs strongly across DO bins: the relative abundance of Cladocera, Copepod, Boatman, Nematode, and Ostracod is not evenly distributed across low, moderate, and high DO groups, X² = 2859.2, df = 8, p < 2.2e-16
